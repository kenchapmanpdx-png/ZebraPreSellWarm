...
"magnesium-bisglycinate": {
        ...
        triadPlain: {
            mcas: "Magnesium doesn't get enough credit for the role it plays in MCAS. The two mechanisms that matter most: magnesium stabilizes mast cells directly by competing at the calcium channels that trigger degranulation, and magnesium deficiency by itself activates mast cells (animal data shows deficient rats run 4-5 fold higher blood histamine within two weeks). Topping up magnesium status removes a major upstream trigger for mast cell misbehavior. For MCAS specifically, we use bisglycinate because it's free of the citric acid and sulfate excipients other magnesium forms often carry, both of which can trigger flares in sensitive patients. The form matters as much as the dose here.",
