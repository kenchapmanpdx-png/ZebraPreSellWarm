...
export const ingredients: Record<string, IngredientData> = {
    "palmitoylethanolamide": {
        ...
        faq: [
            { q: "What does PEA actually do?", a: "PEA is your body's natural anti-inflammatory signal. When your tissue gets stressed, your cells release it to tell nearby nerves and mast cells to chill out. Supplementing PEA boosts that signal so your body can keep up with the demand. It's especially well-studied for nerve pain and inflammatory pain conditions, and it works upstream - lowering how easily pain gets switched on in the first place, not just blocking it after it starts." },
            { q: "Why ultramicronized? Isn't all PEA the same?", a: "Same molecule, completely different absorption. Regular PEA is waxy and barely dissolves - most of it passes right through. Ultramicronized PEA is ground to particles so small your gut can actually absorb it. Every PEA trial that showed real benefit used a micronized or ultramicronized version. The cheap bulk PEA on Amazon usually isn't micronized, which is one reason it disappoints. The form matters more than the dose." },
        ...
        triadPlain: {
            mcas: "PEA is one of the most overlooked tools for MCAS. It activates PPAR-alpha - a receptor that turns down the inflammation switch inside cells - and boosts your body's own endocannabinoids, which tell mast cells to stop releasing histamine. Lab studies show 50-60% reductions in histamine release at concentrations your body can realistically reach. The big advantage over a lot of mast cell options: PEA doesn't lose its punch over time (no tachyphylaxis), and it's gentle enough that even hyper-sensitive patients usually tolerate it well. We pair it with luteolin because the two together hit more pathways than either one alone.",
            ...
            pots: "PEA targets the inflammation layer that fuels so many POTS symptoms - especially the post-viral and post-COVID cases where neuroinflammation is increasingly recognized as a key driver. As one of the best-studied natural neuroinflammation calmers, it addresses the parts of the POTS picture that propranolol and salt tablets just don't touch. Many POTS patients also have MCAS or hEDS along for the ride, and PEA hits both. If your POTS comes with chronic pain, brain fog, or persistent inflammation symptoms, PEA is one of the most useful additions to the protocol."
        },
        bluf: "Palmitoylethanolamide (PEA) is a fatty acid amide your body produces to dampen inflammation and stabilize mast cells, primarily through PPAR-alpha activation in the ALIA pathway. Lab studies show roughly 54% reduction in histamine release at therapeutic concentrations, relevant for MCAS. ZebraWell uses 1,200 mg daily of ultramicronized PEA in the Daily Powder, split AM and PM.",
        atAGlance: {
    ...
    "luteolin": {
        ...
        faq: [
            ...
            { q: "Why does luteolin need a special form?", a: "Standard luteolin powder barely dissolves in water and barely makes it through your gut wall. The forms with real clinical data behind them use micronization - particles ground to single-digit microns so your body can actually absorb them. We use a micronized form to get something closer to the bioavailability levels tested in the human trials. The cheap retail luteolin tablets you'll find at most stores aren't micronized, and it shows." },
...
"magnesium-bisglycinate": {
        ...
        faq: [
            ...
            { q: "How does magnesium help with mast cells?", a: "Magnesium is essential for DAO - the enzyme that breaks down histamine in your gut. When you're low on magnesium, DAO drops and histamine builds up. Lab studies also show that magnesium deficiency by itself activates mast cells: deficient rats run 4-5x normal blood histamine within two weeks. So topping up your magnesium status removes one of the bigger triggers for mast cell misbehavior. For most people in this community, this fix matters more than they realize." },
        ...
        triadPlain: {
            mcas: "Magnesium doesn't get enough credit for the role it plays in MCAS. It's essential for DAO, the enzyme that breaks histamine down in your gut - low magnesium means low DAO means slower histamine clearance. Magnesium deficiency by itself activates mast cells, with solid animal data showing big jumps in histamine release in deficient states. So topping up magnesium removes a major upstream trigger for mast cell misbehavior. For MCAS specifically, we use bisglycinate because it's free of the citric acid and sulfate excipients that other magnesium forms often carry - both of which can trigger flares in sensitive patients. The form matters as much as the dose here.",
            heds: "Magnesium is a cofactor in over 300 enzyme reactions, including several involved in muscle relaxation and collagen-related signaling. For hEDS specifically, the most reliable benefits are practical: less muscle tension, fewer cramps, calmer sympathetic tone, better sleep. Animal and lab studies show magnesium can also inhibit MMPs (the enzymes that degrade collagen), adding an ECM-protective angle. People with hEDS often describe magnesium as the supplement that makes everything else work better - the foundation that lets your system actually do its job.",
        ...
        bluf: "Magnesium bisglycinate is magnesium chelated to two glycine molecules, the form with the best absorption and the cleanest gut profile for mast-cell-sensitive patients. It stabilizes mast cells by competing at calcium channels, supports HRV in POTS, and serves as a foundational electrolyte. ZebraWell uses 300 mg elemental daily (from 2,400 mg bisglycinate) in the Daily Powder, split AM and PM.",
        atAGlance: {
    ...
    "pine-bark-extract": {
        ...
        faq: [
            ...
            { q: "Does pine bark help with the leg swelling and pooling in POTS?", a: "There's a strong literature for pine bark extract in venous insufficiency - multiple RCTs showing reduced edema and improved venous tone, including one where pine bark alone outperformed compression stockings for ankle swelling. Blood pooling in the legs is a core POTS mechanism, so this is directly relevant. The BP meta-analysis (7 RCTs, 626 people) shows no significant effect, so pine bark won't make orthostatic hypotension worse - a clean win for POTS." },
    ...
    "nicotinamide-riboside": {
        ...
        bluf: "Nicotinamide Riboside (NR) is a specialized form of vitamin B3 that raises cellular NAD+ for energy and DNA repair. It directly suppresses mast cell degranulation via SIRT6 and inhibits MMP enzymes that degrade collagen in hEDS. ZebraWell uses 500 mg daily of generic NR chloride with COA verification, chosen over NMN to avoid the 87% NMN counterfeit rate.",
        atAGlance: {
    ...
    "vitamin-c": {
        ...
        triadPlain: {
            mcas: "Vitamin C raises DAO activity - that's the enzyme that breaks histamine down in your gut, and it's part of standard MCAS protocols for good reason. It also lowers circulating histamine: IV studies showed a 30% drop within hours, with even stronger effects in allergic patients. For oral dosing, the main mechanisms are steady DAO support and antioxidant action against the oxidative stress that mast cell activation generates. We chose sodium ascorbate specifically because the acidic forms can irritate MCAS guts, and because the citric acid commonly used as a buffer in other vitamin C products is one of the most-reported MCAS trigger ingredients.",
            heds: "Vitamin C is the only nutrient with a non-negotiable role in collagen synthesis. The enzymes that hydroxylate proline and lysine - the modification that lets collagen fold into its stable triple helix - physically cannot work without vitamin C present as a cofactor. Below the threshold, the enzymes idle. Above it, they work at full speed. The 2024 Danish study showing roughly 6x higher rates of suboptimal vitamin C in hypermobile patients suggests this threshold issue is unusually common here. Vitamin C also supports TIMP-1 (one of your body's natural MMP inhibitors), giving it a real ECM-protective angle on top of the structural support.",
    ...
    "vitamin-d3": {
        ...
        faq: [
            ...
            { q: "Why D3 and K2 together?", a: "They work as a pair. D3 increases your body's calcium absorption from the gut. K2 - specifically MK-7, the long-acting form - activates the proteins that direct that calcium where it belongs: bones and teeth. Without K2, the extra calcium D3 makes available can deposit in arteries and soft tissues, which is not what you want long-term. The pairing is standard practice for any D3 dose above 1,000 IU daily. We include both in the AM capsule for dosing simplicity." },
            { q: "What about vitamin D and mast cells?", a: "The data is complex. Vitamin D acts as a hormone with mast cell stabilization effects through the VDR - lab studies consistently show reduced degranulation, lower IL-4, and dampened FcεRI signaling at adequate D levels. MCAS cohorts paradoxically have better D status than the general population, suggesting deficiency isn't the primary driver. The honest take: D3 doesn't cause MCAS, doesn't cure it, and the mast cell mechanisms are real. Continue supplementation; don't expect it to be the answer." }
        ],
        triadPlain: {
        ...
        bluf: "Vitamin D3 is a fat-soluble hormone that regulates calcium, supports immune function, and stabilizes mast cells. About 51% of POTS patients run deficient; correcting the deficit produces mast cell stabilization and autonomic support that supplementation studies have repeatedly shown. ZebraWell uses 2,000 IU daily, paired with K2 to route calcium correctly.",
        atAGlance: {
    ...
    "vitamin-k2": {
        ...
        faq: [
            ...
            { q: "Why not natto-derived MK-7?", a: "Natto is the traditional fermented soybean source of MK-7, and it's the source most commonly used in commercial supplements because it's cheap and natural. The problem for our community: natto is heavily fermented and contains substantial biogenic amines (histamine, tyramine, polyamines) that ride along even in extracted MK-7 products. For MCAS patients, this is a documented trigger pattern. Synthetic MK-7 and chickpea-fermented MK-7 produce the same molecule without the biogenic amine baggage. Same molecule; different contamination profile." },
            { q: "Does K2 actually help with mast cells?", a: "Yes, with caveats. The strongest evidence is historical - Kimura's 1975 studies (rat mast cells and human basophils from asthma patients) showed K2 significantly inhibited both IgE-mediated and antibody-induced mast cell degranulation. A 2021 pediatric atopic dermatitis study (Zhang) showed K2 suppressed IL-17A, IL-10, and TNF-α through MAPK/ERK inhibition. The mechanism is real but understudied in MCAS specifically. We don't pitch K2 as a primary mast cell stabilizer - it's secondary support alongside the dedicated stabilizers (PEA, luteolin, quercetin, astaxanthin)." }
        ],
        triadPlain: {
    ...
    "benfotiamine": {
        ...
        triadPlain: {
            ...
            pots: "For POTS, benfotiamine's strongest case is the B1 deficiency subset identified in the 2017 SUNY Buffalo retrospective review. About 6% of POTS patients were B1-deficient, and a quarter of that subset improved on oral thiamine - modest numbers, but a real subgroup. The mitochondrial support angle matters for the chronic fatigue that runs alongside POTS in most patients. Important caveat: the 2026 BOND trial at 600 mg for a year showed no improvement in any autonomic function test, so the historical 'high-dose benfotiamine for autonomic dysfunction' framing isn't supported. Our 150 mg dose is foundational B1 coverage."
        },
        bluf: "Benfotiamine is a fat-soluble form of vitamin B1 (thiamine) with roughly 5-fold greater bioavailability than standard thiamine. It supports mitochondrial energy production. About 6% of POTS patients are frankly thiamine deficient, and 25% of those respond meaningfully to supplementation. ZebraWell uses 150 mg daily.",
        atAGlance: {
    ...
    "p5p": {
        ...
        faq: [
            ...
            { q: "How does P5P help with histamine?", a: "P5P is the essential cofactor for DAO (diamine oxidase) - the enzyme that breaks down histamine in your gut before it enters circulation. Without adequate P5P, DAO activity drops by up to 50%. A 2024 Clinical Chemistry study showed that B6 levels over 20 µg/L produced 20% better histamine clearance compared to deficient B6 levels. P5P doesn't replace DAO supplementation directly, but it makes whatever DAO you produce or supplement work properly. It's foundational for histamine management." },
            { q: "Does P5P stabilize mast cells directly?", a: "There's moderate evidence. A 2022 study (Kazama) showed P5P produces dose-dependent mast cell suppression, synergistic with vitamin C. An older 1979 study (García) reported a cromolyn-like mast cell stabilizing profile. The mechanism likely involves both direct mast cell membrane effects and the histamine clearance support through DAO. We don't lead with mast cell stabilization for P5P - the DAO cofactor work is the stronger evidence base - but the direct effect is documented." },
        ...
        triadPlain: {
            mcas: "P5P is one of the most directly MCAS-relevant B vitamins. It's the essential cofactor for DAO (diamine oxidase), the enzyme in your gut that breaks down histamine before it reaches circulation. Without adequate P5P, DAO activity can drop by up to 50%. German and Austrian clinical research has established this as the primary B6 mechanism for histamine intolerance and MCAS - the principle 'DAO is practically useless without B6' is foundational. P5P also has documented direct mast cell stabilization in lab studies (Kazama 2022, synergistic with vitamin C). Both mechanisms support the broader MCAS strategy.",
        ...
        bluf: "P5P is the active coenzyme form of vitamin B6, immediately usable by the body without conversion. It serves as a key cofactor for DAO, the enzyme that breaks down histamine, making it critical for MCAS, and it supports neurotransmitter synthesis for autonomic regulation. ZebraWell uses 50 mg daily.",
        atAGlance: {
...
"astaxanthin": {
        ...
        faq: [
            ...
            { q: "How is your astaxanthin sourced?", a: "Natural astaxanthin from Haematococcus pluvialis algae, US-origin sourcing required, all-E isomer dominant (over 60%), 9-cis at or below 17.3%, no carrageenan or fermented carriers. The COA is verified on every batch. We considered branded options but found that generic astaxanthin meeting these specs delivers equivalent clinical performance at meaningfully lower cost. The spec is what matters: source organism, isomer profile, US-origin, clean carriers. The 4 mg active dose is within the validated clinical range." },
...
"l-theanine": {
        ...
        triadPlain: {
            ...
            heds: "L-theanine doesn't have a direct connective tissue mechanism - it's not a collagen or matrix ingredient. The hEDS-relevant role is the autonomic and stress-response layer: chronic sympathetic activation in hEDS contributes to the wired-but-exhausted pattern many patients describe, and elevated stress hormones over time also amplify MMP expression and matrix degradation. L-theanine's parasympathetic-supportive activity helps quiet the chronic-stress background that runs alongside hEDS for most people. It's a quality-of-life ingredient for the triad rather than a direct ECM contributor. The hEDS-protective work happens elsewhere in the formulation.",
...
"zinc-carnosine": {
        ...
        faq: [
            { q: "Why split into AM and PM?", a: "Every human RCT showing zinc carnosine's gut barrier benefit used 37.5 mg twice daily, not 75 mg once. The mechanism is local: zinc carnosine coats the gut lining and stabilizes tight junctions, but it gets cleared from the GI tract within about 2 hours. Once-daily dosing leaves a long window where the protective coating isn't present. Splitting AM and PM keeps protection active across both digestive periods. The total daily dose (75 mg) matches the trial protocols exactly." },
        ...
        bluf: "Zinc Carnosine is a unique 1:1 chelate of zinc and L-carnosine that adheres to the gut lining. It has the strongest human evidence of any supplement for protecting intestinal permeability, while also providing direct mast cell stabilization in the GI tract where MCAS symptoms often start. ZebraWell uses 75 mg daily, split 37.5 mg AM and PM.",
        atAGlance: {
...
"pantothenic-acid": {
        ...
        faq: [
            ...
            { q: "What does pantothenic acid actually do?", a: "Pantothenic acid is the precursor to Coenzyme A (CoA) - a molecule required for hundreds of enzymatic reactions. CoA is essential for energy production (the citric acid cycle, fatty acid oxidation), synthesis of fatty acids, cholesterol, and steroid hormones, and production of acetylcholine (a major neurotransmitter). The 'pantothenic' name (meaning 'from everywhere') reflects how broadly this molecule is needed. Most of B5's value is foundational metabolic support - you don't notice it specifically, but every cell needs it." },
    ...
    "biotin": {
        ...
        bluf: "Biotin is an essential B vitamin that serves as a cofactor for the carboxylase enzymes that drive mitochondrial energy production. The profound fatigue common in the triad correlates with mitochondrial inefficiency, which is exactly what biotin supports. ZebraWell uses 300 mcg daily in the PM stack.",
        atAGlance: {
    ...
    "molybdenum": {
        ...
        bluf: "Molybdenum is an essential trace mineral required for the enzymes that detoxify sulfites and aldehydes. Sulfite metabolism issues are a recognized trigger for mast cell degranulation in MCAS, and most multivitamins skip molybdenum entirely. ZebraWell uses 150 mcg daily in the PM stack.",
        atAGlance: {
    ...
    "copper-bisglycinate": {
        ...
        faq: [
            ...
            { q: "Why does copper matter for connective tissue?", a: "Copper is the essential cofactor for lysyl oxidase (LOX), the enzyme that creates cross-links between collagen and elastin fibers. Cross-links are what give connective tissue its tensile strength - they're the difference between a strong, well-organized matrix and a fragile, easily-deformed one. The genetic copper-deficiency disorders (Menkes disease, occipital horn syndrome) actually produce a phenotype that overlaps with EDS, demonstrating how essential copper is for proper collagen architecture. For hEDS specifically, copper adequacy is foundational." }
        ],
        triadPlain: {
    ...
    "manganese-bisglycinate": {
        ...
        faq: [
            { q: "Why is manganese in the formulation?", a: "Manganese is essential for several connective tissue enzymes that don't get much attention. Prolidase recycles proline (a major component of collagen) for new collagen synthesis. Glycosyltransferases handle the post-translational modification of collagen - adding sugar molecules that affect collagen folding and stability. Manganese is also the cofactor for MnSOD, your mitochondria's primary antioxidant. A 2021 study (Dong) showed manganese deficiency upregulates MMP-1, MMP-9, and MMP-13 - the same matrix-degrading enzymes elevated in hEDS. Adequate manganese keeps that pathway quieter." },
            ...
            { q: "Does manganese trigger mast cells?", a: "No - actually the opposite. Manganese competes with calcium at calcium channels (Hide & Beaven 1991), inhibiting the calcium influx that triggers mast cell degranulation. Manganese-containing SOD mimetics reduced mast cell degranulation in allergic asthma models (Masini 2005). Manganese porphyrin treatment reduced histamine content in mast cells (Tagen 2009). The MCAS-relevant effect runs both through direct calcium-channel competition and indirect MnSOD-driven reduction in oxidative stress, which stabilizes mast cells. No evidence supports manganese as a mast cell trigger." },
    ...
    "selenium": {
        ...
        faq: [
            ...
            { q: "Does selenium help with thyroid?", a: "Yes, indirectly relevant. Selenium is the cofactor for deiodinase enzymes that convert T4 (the inactive thyroid hormone) into T3 (the active form). Selenium is also essential for the selenoproteins that protect the thyroid gland from oxidative damage. Several studies show selenium supplementation reduces TPO antibodies in Hashimoto's thyroiditis - and Hashimoto's commonly overlaps with POTS and MCAS. If your thyroid panel is borderline or you have known thyroid antibodies, the selenium contribution may be more clinically relevant for you." },
    ...
    "grape-seed-extract": {
        ...
        faq: [
            ...
            { q: "How does grape seed help with mast cells?", a: "Grape seed procyanidins stabilize mast cells through three pathways in lab studies: downregulating FcεRI (the IgE receptor that triggers allergic-style activation), inhibiting calcium influx (the trigger for degranulation), and raising cAMP (which actively suppresses release). The mechanism is similar to cromolyn but operates across more pathways. For MCAS patients with overlapping connective tissue or vascular symptoms, grape seed addresses both the mast cell and ECM-protective layers at once." },
    ...
    "chlorogenic-acid": {
        ...
        faq: [
            { q: "Is chlorogenic acid the same as coffee?", a: "It's the polyphenol found in coffee, but you can't get a useful supplement dose from drinking coffee - and coffee comes with caffeine, which is a problem for many people in this community. Our CGA comes from decaffeinated green coffee bean extract (the unroasted bean has higher CGA content than roasted coffee), standardized to deliver 200 mg of CGA per day. Less than 2% residual caffeine, no coffee taste, none of the caffeine-driven mast cell or autonomic effects." },
            ...
            { q: "Does chlorogenic acid help with collagen or just mast cells?", a: "Both, actually - which is unusual for a single ingredient. In dermal fibroblast studies, CGA at concentrations achievable from oral dosing increased Type I collagen synthesis through the TGF-β/Smad signaling pathway while simultaneously reducing MMP-1 and MMP-3 - the matrix-degrading enzymes upregulated in hEDS. The collagen-supporting effect happened without driving anti-fibrotic activity that would be counterproductive in hEDS. The mast cell stabilization runs through separate pathways (PPAR-gamma and NF-kB)." },
    ...
    "niacinamide": {
        ...
        faq: [
            ...
            { q: "Does niacinamide actually help with collagen?", a: "In dermal fibroblast studies, yes - niacinamide supports pro-collagen activity at concentrations achievable from oral dosing. It's why niacinamide shows up in skincare and oral skin-health formulations. For hEDS specifically, the connective tissue benefits at 50 mg are modest; the more important effects are NAD+ pathway support (alongside NR), mast cell stabilization (from older lab data), and general B-vitamin coverage. It's a supporting cast ingredient at our dose, not a hero player." },
    ...
    "r5p": {
        ...
        bluf: "R5P is the activated form of vitamin B2 that bypasses the conversion step plain riboflavin requires. Around 85% of hEDS patients carry MTHFR variants where R5P is the cofactor needed for proper methylation. Riboflavin also has strong evidence in migraine prophylaxis, relevant for the 65% of POTS patients who get migraines. ZebraWell uses 25 mg AM.",
        atAGlance: {
